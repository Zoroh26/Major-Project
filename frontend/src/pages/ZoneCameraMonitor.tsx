...
import { ArrowLeft, Activity, Camera, Cpu, MapPin, Timer, Users } from 'lucide-react';
      ...
      <div className="rounded-3xl border border-border bg-card p-4">
        <div className="grid grid-cols-1 lg:grid-cols-[240px_1fr] gap-4 items-start">
          ...
          <section className="min-w-0 space-y-4">
            ...
            <div className="border border-border rounded-2xl p-4 min-w-0 overflow-hidden">
              <h2 className="text-sm font-bold uppercase tracking-wide text-primary/70 mb-3">Live feed (no detection)</h2>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-[1.45fr_1fr] gap-4">
              <div className="border border-border rounded-2xl p-4 min-w-0 overflow-hidden">
              <h2 className="text-sm font-bold uppercase tracking-wide text-primary/70 mb-3">YOLO preview + heatmap overlay</h2>
              ...
              <div className="border border-border rounded-2xl p-4 min-w-0 overflow-hidden">
              <h2 className="text-sm font-bold uppercase tracking-wide text-primary/70 mb-3">Heatmap only</h2>
              <div className="h-[58vh] min-h-[420px] max-h-[680px] rounded-lg overflow-hidden border border-border">
